package net.mcreator.elementaltoolsmod;
...
@Mod("elemental_tools_mod")
public class ElementalToolsModMod {
	public static final Logger LOGGER = LogManager.getLogger(ElementalToolsModMod.class);
	public static final String MODID = "elemental_tools_mod";

	public ElementalToolsModMod(FMLJavaModLoadingContext context) {
