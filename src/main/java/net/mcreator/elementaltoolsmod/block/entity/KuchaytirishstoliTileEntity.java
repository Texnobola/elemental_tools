package net.mcreator.elementaltoolsmod.block.entity;
...
public class KuchaytirishstoliTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(3, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public KuchaytirishstoliTileEntity(BlockPos pos, BlockState state) {
		super(ElementalToolsModModBlockEntities.KUCHAYTIRISHSTOLI.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(KuchaytirishstoliBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<KuchaytirishstoliTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<KuchaytirishstoliTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("kuchaytirishstoli");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Kuchaytirish stoli");
	}
