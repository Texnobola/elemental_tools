package net.mcreator.elementaltoolsmod.world.inventory;
...
public class TableguiMenu extends AbstractContainerMenu implements ElementalToolsModModMenus.MenuAccessor {
	...
	public TableguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
